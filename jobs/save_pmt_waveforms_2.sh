#!/bin/bash
#SBATCH --qos=regular
#SBATCH --job-name=wf_2308_2
#SBATCH --output=/scratch/elena/WCTE_DATA_ANALYSIS/waveform_npz/run2308/logs/wf_2308_2_%A_%a.out
#SBATCH --error=/scratch/elena/WCTE_DATA_ANALYSIS/waveform_npz/run2308/logs/wf_2308_2_%A_%a.err
...
#SBATCH --mem=16G
#SBATCH --time=4:00:00
#SBATCH --array=1000-1999%100               #total tasks=number of lines in "tasks.txt" - 1 is 2472; up to 50 array tasks at once
