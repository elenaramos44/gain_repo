...
#SBATCH --output=/scratch/elena/WCTE_DATA_ANALYSIS/waveform_npz/run2306/logs/merge_wf_2307_%A_%a.out
#SBATCH --error=/scratch/elena/WCTE_DATA_ANALYSIS/waveform_npz/run2306/logs/merge_wf_2307_%A_%a.err
