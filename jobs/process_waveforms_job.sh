#!/bin/bash
#SBATCH --job-name=step1_wf_2306_770
#SBATCH --output=/scratch/elena/WCTE_DATA_ANALYSIS/waveform_npz/run2306/logs/step1_wf_2306_770_%A_%a.out
#SBATCH --error=/scratch/elena/WCTE_DATA_ANALYSIS/waveform_npz/run2306/logs/step1_wf_2306_770%A_%a.err
...
PULSE_WIDTH=770ps  # Change to 780ps or 790ps as needed
...
#echo "[INFO] STEP 1: Processing run=${RUN}, chunk=${CHUNK_ID}"
